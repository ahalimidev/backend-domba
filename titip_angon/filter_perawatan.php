...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $kondisi_x =  $kondisi == "0" || $kondisi == "" || $kondisi == null ? "" : "ORDER BY treatmentmst_tb.fd_treatdate $kondisi";
    $date_x =  $awal == "0" && $akhir =="0" || $awal == "" && $akhir =="" || $awal == null && $akhir ==null ? "" : " AND date(treatmentmst_tb.fd_treatdate) >=  '$awal' AND date(treatmentmst_tb.fd_treatdate) <= '$akhir' ";
    ...
    if (mysqli_num_rows($sql) > 0) {
        ...
        WHERE treatmentdtl_tb.fn_sheepid = '$fn_sheepid' $date_x
