...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $kondisi_x =  $kondisi == "0" || $kondisi == "" || $kondisi == null ? "" : "ORDER BY fd_devdate $kondisi";
    $date_x =  $awal == "0" && $akhir =="0" || $awal == "" && $akhir =="" || $awal == null && $akhir ==null ? "" : " AND date(fd_devdate) >=  '$awal' AND date(fd_devdate) <= '$akhir' ";
    ...
    if (mysqli_num_rows($sql) > 0) {
        ...
        $x = mysqli_query($con, "SELECT fd_devdate,fn_weight, fn_height,fv_characteristics,fv_desc FROM sheepdevelopment_tb WHERE  fn_sheepid = '$fn_sheepid' $date_x $kondisi_x");
