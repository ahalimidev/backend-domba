...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $kondisi_x =  $kondisi == "0" || $kondisi == "" || $kondisi == null ? "" : " ORDER BY sheep_tb.fd_dateofbirth $kondisi";
    $date_x =  $awal == "0" && $akhir =="0" || $awal == "" && $akhir =="" || $awal == null && $akhir ==null ? "" : " AND date(sheep_tb.fd_dateofbirth) >=  '$awal' AND date(sheep_tb.fd_dateofbirth) <= '$akhir' ";
    ...
    where registerkavsheep_tb.fn_kavid = '$fn_kavid'  $date_x  $kondisi_x");
